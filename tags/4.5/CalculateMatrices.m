...
Structure.DampingMatrixFreeIntegratorSetup2=Structure.DampingMatrixFreeIntegratorSetup;

% Modification to Mass Matricies necessary for Rosenbrock-W Method
if (Integrator.MethodID == 2)
    Structure.MassMatrixFree = Structure.MassMatrixFree + ...
            Integrator.Gamma*Integrator.Timestep*Structure.DampingMatrixFree + ...
            Integrator.Gamma^2*Integrator.Timestep^2*Structure.StiffnessMatrixFree;
    Structure.MassMatrixFreeInv = inv(Structure.MassMatrixFree);
end