function varargout = CreateBusWithDimensions(varargin) 
% This is a modified Simulink.Bus.createObject function.  If Mathworks ever
% corrects the creation of a Bus object for multi-dimensions, then this can
% be deleted and modified in the source.
%
